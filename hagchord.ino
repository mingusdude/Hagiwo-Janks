// Chord Oscillator
//
// Based on Design by Hagiwo
// Original code from Mzuelch
// 
// Mods on 27 Apr 2023 by @mingusdude - Michael Hurt
// - switched pin 3 to 2 to match schematics, and thus work with vco board from @todbot
// 
//
//
...
void updateControl() {
 //chord setting
 chord = (mozziAnalogRead(2) / 128) + (mozziAnalogRead(5) / 128);
